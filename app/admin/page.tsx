  ...
  const pendingFarmers = [
    {
      ...
      products: "Goats, Sheep",
      documents: { aadhaar: true, pan: true, photo: true },
      videoUploaded: true,
    ...
    },
    {
      ...
      products: "Desi Chicken",
      documents: { aadhaar: true, pan: false, photo: true },
      videoUploaded: false,
      appliedDate: "2025-12-23",
    },
  ];
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        >
          ...
          <TabsContent value="farmers" className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold">Farmer Management</h2>
              <div className="flex gap-2">
